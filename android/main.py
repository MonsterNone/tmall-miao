...
原项目: https://github.com/MonsterNone/tmall-miao

使用方法：
    1. 确保手机/模拟器已开启 USB 调试并连接到电脑
    2. 手机首次使用需初始化：python -m uiautomator2 init
    3. 运行：python main.py
"""
import os
import platform
...
{Colors.HEADER}║          {Colors.WARNING}Android (uiautomator2) 版{Colors.ENDC}{Colors.HEADER}          ║{Colors.ENDC}
{Colors.HEADER}║                                          ║{Colors.ENDC}
{Colors.HEADER}╚══════════════════════════════════════════╝{Colors.ENDC}
"""
