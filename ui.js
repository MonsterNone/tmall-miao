...
ui.tbHb.click(function () { openTbUrl('https://s.click.taobao.com/xHjaAsu') })
ui.tbHb1.click(function () { openTbUrl('https://s.click.taobao.com/xHjaAsu') })

ui.jdHb.click(openJdHb)
ui.jdHb1.click(openJdHb)

ui.tb1.click(function () { openTbUrl('https://s.click.taobao.com/CZqm9BV') })
ui.tb2.click(function () { openTbUrl('https://s.click.taobao.com/q40URHV') })
ui.tb3.click(function () { openTbUrl('https://s.click.taobao.com/tF8yBOC') })
ui.tb4.click(function () { openTbUrl('https://s.click.taobao.com/T8UKw0b') })
ui.tb5.click(function () { openTbUrl('https://s.click.taobao.com/oBjJahF') })
ui.jd1.click(function () { openJdUrl('https://u.jd.com/hwIjkDL') })
ui.jd2.click(function () { openJdUrl('https://u.jd.com/hKIkaDn') })
ui.jd3.click(function () { openJdUrl('https://u.jd.com/hKIw1zG') })
ui.jd4.click(function () { openJdUrl('https://u.jd.com/hwIsiKj') })
ui.jd5.click(function () { openJdUrl('https://u.jd.com/hwIajDo') })
...
function openJdHb() {
    const url = 'https://u.jd.com/mIDaWtY'
    const text = '88￥VCToY8cBzRtPtEzZ￥'
    dialogs.build({
        title: "是否使用复制京口令领取？",
